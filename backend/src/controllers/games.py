...
from src.models.games import NewGame, create_game, get_game as get_game_model, get_user_to_pick as get_user_to_pick_model
...
def get_user_to_pick(game_id: str) -> str:
    ...
    return {"user_to_pick": user_to_pick}
